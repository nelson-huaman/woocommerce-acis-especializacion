<div class="wc_curso__item">
   ...
   <div class="wc_curso__contenido wc_curso__contenido--premium">
      <div class="wc_curso__header">
         ...
         <div class="wc_curso__slogan wc_curso__slogan--premium">+ 170 Cursos</div>
         <div class="wc_curso__precio wc_curso__precio--premium">S/ <span>0</span></div>
      ...
      <div class="wc_curso__body ">
         ...
         <div class="wc_curso__pagar">
            <div class="wc_curso__pagar--label">Total a pagar</div>
